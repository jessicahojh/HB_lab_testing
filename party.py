...
def is_mel(name, email):
    ...
    >>> is_mel('Jenica Jess', 'jennisca@gmail.com')
    False

    >>> is_mel('Mel Melitpolski', 'jj@gmail.com')
    True

    >>> is_mel('Jenica Jess', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type':'dessert'},{'type':'dessert'},{'type':'dessert'},{'type':'dessert'},{'type':'drink'},{'type':'drink'},{'type':'drink'},{'type':'drink'},{'type':'drink'},{'type':'app'}])
    ('drink', 'app')

    >>> most_and_least_common_type([{'type':'dessert'},{'type':'dessert'},{'type':'app'}])
    ('dessert', 'app')
